...
//   this activity handles the 4x4 board game with two human   //
public class Humangame4x4 extends AppCompatActivity {
    int turn = 1;
    int win = 0;
    int gamov = 0;
    int flagEndGame=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_humangame4x4);
    ...
    public void checkWin() {
        ...
        if (playBoard[0][3].getText().toString().equals(playBoard[1][2].getText().toString()) && playBoard[0][3].getText().toString().equals(playBoard[2][1].getText().toString()) && playBoard[0][3].getText().toString().equals(playBoard[3][0].getText().toString())) {
            ...
            if (!playBoard[3][0].getText().toString().equals(" ")) {
                ...
                playBoard[2][1].setTextColor(Color.RED);
                playBoard[1][2].setTextColor(Color.RED);
                playBoard[0][3].setTextColor(Color.RED);
