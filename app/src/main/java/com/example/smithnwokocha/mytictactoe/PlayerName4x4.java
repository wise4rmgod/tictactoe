...
// this activity ask for the user name and number of games  for the two humans //
public class PlayerName4x4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_player_name4x4);
...
//        }
        ...
        Intent intent = new Intent(this, Humangame4x4.class);
